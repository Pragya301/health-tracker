...
function App() {
  ...
  const router = createBrowserRouter([
    ...
    {
      path: "/navbar", element: <Navbar habits={habits} setHabits={setHabits} />,
      children: [
        {path: "daily", element: <Daily habits={habits} setHabits={setHabits} /> },
        {path: "weekly", element: <Weekly habits={habits} setHabits={setHabits} />,
        },
      ],
    },
  ]);
